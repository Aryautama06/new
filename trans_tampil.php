...
<table>
    ...
    <td><?php echo $no++; ?></td>
        ...
        <td><a href="index.php?hal=trans_edit&id=<?php echo $row['trans_id']; ?>" class="container">Edit</a></td>
        <td><a href="index.php?hal=trans_delete&id=<?php echo $row['trans_id']; ?>" class="container" onclick="return confirm('Apakah anda yakin?')">Delete</a></td>
    </tr>
    <?php } ?>
</table>